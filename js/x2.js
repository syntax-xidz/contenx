...
function getDeviceCategory(filename) {
    ...
    if (lower.includes("x86") || lower.includes("x86-64") || lower.includes("amd64") || lower.includes("x86-32") || lower.includes("386") || lower.includes("i386") || lower.includes("i386_pentium4")) return "x86";
...
function getDownloadTimeLeft() {
    ...
    const timeLeft = twoMinute - timeDiff;
...
function initWizard() {
    ...
    const x86Count = builds.filter(b => b.device === 'x86').length;
    ...
    wizard.innerHTML = `
        ...
        <div class="step-card active">
            ...
            <div class="device-buttons">
                ...
                <button class="device-btn" data-device="x86">X86 (${x86Count})</button>
            </div>
        </div>
        <div class="step-card active">
