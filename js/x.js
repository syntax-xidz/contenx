...
const contentData = {
    ...
    features: {
        items: [
            { title: 'Fitur Utama', list: ['Tema Argon ⨯ Tema RTA-wrt ⨯ Tema Alpha', 'Amlogic Service ( Amlogic Devices )', '3ginfo-Lite ⨯ Modeminfo ⨯ IP Information', 'Fix TTL ( ON / OFF ) ⨯ Tailscale ⨯ Netmonitor', 'Eqosplus ⨯ Droidnet ⨯ File manager', 'GPIO LED Support HG680P - B860H', 'MODSDCARD Support HG680P - B860H', 'Tersedia WIFI ON | OFF HG680P - B860H', 'Internet Detector ⨯ Connection Monitor', 'XDEV Tools ⨯ XIDZs Bot Monitoring', 'Configurasi Openclash ⨯ Nikki ⨯ Passwall'] },
            { title: 'Khusus Amlogic Devices Tertentu', list: ['Kernel Versi 5.15.x', 'Kernel Versi 6.1.x', 'Kernel Versi 6.6.x', 'Kernel Versi 6.12.x'] },
            { title: 'Tunnel Options', list: ['OpenClash', 'Nikki', 'OpenClash + Nikki', 'Openclash + Insomclash', 'OpenClash + Nikki + Passwall', 'No Tunnel'] }
        ]
    },
    about: {
        items: [
