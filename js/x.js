...
const contentData = {
    preview: {
        items: [
            ...
            { title: 'Tema Rtawrt Dark', image: '../asset/rta_dark.png' },
            ...
            { title: 'XDEV Script Tools', image: '../asset/xdev_tools.png' }
    ...
    features: {
        items: [
            { title: 'Fitur Utama', list: ['Tema Argon ⨯ Tema Alpha', 'Amlogic Service ( Amlogic Devices )', '3ginfo-Lite ⨯ Modeminfo ⨯ IP Information', 'Fix TTL ⨯ Tailscale ⨯ Netmonitor', 'Eqosplus ⨯ Droidnet ⨯ File manager', 'GPIO LED Support', 'MODSDCARD Support HG680P - B860H', 'Tersedia WIFI ON | OFF HG680P - B860H', 'Internet Detector ⨯ Connection Monitor', 'XDEV Script Tools ⨯ XIDZs Bot Monitoring', 'Configurasi Openclash ⨯ Nikki ⨯ Insomclash ⨯ Passwall'] },
